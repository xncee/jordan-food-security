...
export function createRainfallCard(highlandsRainfall, desertRainfall) {
    const cardBase =
    ...
    return `
      <div class="${cardBase} border-[var(--border)]">
        <div class="text-4xl mb-4">🌧️</div>
        <div>
          <h3 class="text-lg font-semibold mb-4 text-[var(--text-primary)]">Annual Rainfall</h3>
